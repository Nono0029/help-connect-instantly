        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between px-4 pb-3 border-b border-border">
              ...
              <h2 className="text-base font-bold text-foreground">Poster une demande</h2>
              <div className="w-7" />
            </div>
            ...
            <div className="px-4 py-4 space-y-5">
              ...
              <div>
                ...
                <div className="flex gap-2 overflow-x-auto pb-1">
                  <button
                    ...
                    className="shrink-0 w-20 h-20 rounded-xl border-2 border-dashed border-primary/40 bg-primary/5 flex flex-col items-center justify-center gap-1 text-primary hover:bg-primary/10 transition-colors"
                  >
              ...
              <p className="text-center text-[11px] text-muted-foreground pb-4">
                Ta demande sera visible par les personnes autour de toi
              </p>
            </div>
          </motion.div>
        </motion.div>
